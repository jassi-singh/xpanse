...
class GetTransactionsBetweenTwoDates
    extends UseCase<List<Transaction>, TransactionOfMonthParams> {
  final TransactionRepo _repository;

  GetTransactionsBetweenTwoDates(this._repository);

  @override
  Future<Either<Exception, List<Transaction>>> call(
      TransactionOfMonthParams params) async {
    return await _repository.getTransactionsBetweenTwoDates(
